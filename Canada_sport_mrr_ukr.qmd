...
#gamma
Season_model_full_gamma<- glm(formula = (catch_estimate+3) ~creel_plus_summer*status*finescale_fishery_old*season*creel_effort,  family=Gamma(link = "log"), data = Season_south_no_nas)
...
```{r Modelling drop each term, message=FALSE, warning=FALSE, echo=FALSE, eval=FALSE}
...
```{r Modelling model format, message=FALSE, warning=FALSE, echo=FALSE, eval=FALSE}
...
Season_model_gamma_full_spec<- glm(formula = catch_estimate+3 ~creel_plus_summer+finescale_fishery_old+season+status+
                                                 creel_plus_summer:finescale_fishery_old + creel_plus_summer:season +
                                     creel_plus_summer:status+ finescale_fishery_old:season + finescale_fishery_old:status + season:status ,  family=Gamma(link = "log"), data = Season_south_no_nas)
...
AICtab(Season_model_gamma_full_spec, Season_model_full_gamma)



```

```{r Modelling subsetting old, message=FALSE, warning=FALSE, results='hide', echo=FALSE, eval=FALSE}
