...
```{r Allocating unchecked catch, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r calculating catch estimate, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r summarizing by old finescale fishery, echo=FALSE, message=FALSE, warning=FALSE}
