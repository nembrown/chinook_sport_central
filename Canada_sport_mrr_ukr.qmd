...
Sport_mark_rate_finescale<-
  ...
  mutate(finescale_fishery = case_when(
    ...
    (AREA %in%c("Area 17", "Area 18", "Area 19 (GS)", "Area 28", "Area 29") |REGION2== "GSS")& season=="fall" ~ "SGS S FALL", 
...
-   Further investigation showed that the best model dropped both kept status and creel effort but no further terms:
...
-   Therefore the best model included mark status, finescale fishery and season
...
Season_south_old_new<-predict.glm(Season_model_gamma_drop_kept_effort, newdata =  Season_south_old, type = "response")
